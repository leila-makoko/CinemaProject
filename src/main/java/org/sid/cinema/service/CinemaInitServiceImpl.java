...
@Service
@Transactional
public class CinemaInitServiceImpl implements ICinemaIniitService {
@Autowired
...
@Autowired
	...
	public void initCinemas() {
		...
		villeRepository.findAll().forEach(v->{
			...
			Stream.of("MegaRam","IMax","CinePLus","MallCine","Daouliz")
			.forEach(nameCinema->{
	...
	DateFormat dateFormat=new SimpleDateFormat("HH:mm");
			...
			Stream.of("12:00","16:00","15:00","19:00","14:00","17:00")
			.forEach(s->{
	...
	public void initCategories() {
		Stream.of("Fiction","Action","Drama","Histoire")
		.forEach(cat->{
	...
	public void initFilms() {
		...
		double [] durees =new double []{1,2,2,3,1,5};	
		
		List<Categorie>categories= categorieRepository.findAll();
		Stream.of("dora", "albatros","Myster ","rose","corona")
		.forEach(titreFilm->{
	...
	public void initProjections() {
		...
		double [] prices =new double []{30,20,40,50,90,100,70};	
